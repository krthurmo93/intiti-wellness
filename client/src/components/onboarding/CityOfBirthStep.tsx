...
interface CityOfBirthStepProps {
  value: string;
...
export function CityOfBirthStep({ value, onChange, onNext, onBack }: CityOfBirthStepProps) {
      ...
      <div className="w-full max-w-md">
        ...
        >
          ...
          <p className="text-stone-500 text-center font-sans">
            This unlocks your full birth chart.
          </p>
        </motion.div>
        ...
        <form onSubmit={handleSubmit} className="space-y-8">
          ...
          >
            ...
            />
            {touched && !isValid && (
              <p className="text-sm text-red-500 mt-2 text-center">Please enter your birth city</p>
            )}
          </motion.div>
          ...
          {[0, 1, 2, 3, 4, 5, 6].map((i) => (
            <div
              ...
              className={`w-2 h-2 rounded-full transition-all ${
                i === 5 ? "bg-amber-500 w-6" : "bg-stone-300"
              }`}
            />
          ))}
        </div>
